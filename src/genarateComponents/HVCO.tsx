...
type hvcoGuidHeadLine = {
  highlight: string;
  main: string;
  second: string;
};
type HvcoGuideValuesItems = {
  lable: string;
  price: string;
  isFree: boolean;
};

type hvcoGuideValuesItemsProps = HvcoGuideValuesItems[];
type hvcoFormInputProps = hvcoFormInputs[];
...
type HvcoProps = {
  ...
  hvcoEyebrow: string;
  hvcoheader: HeadeLine;
  hvcoPhara: string;
  hvcoItems: string[];
  hvcoFormLbl: string;
  hvcoFormInput: hvcoFormInputProps;
  hvcoFormBtn: string;
  hvcoFormBottomLbl: string;
  hvcoGuideCoverLbl: string;
  hvcoGuidHeadLine: hvcoGuidHeadLine;
  hvcoGuideCoverSub: string;
  hvcoCoverBy: string;
  hvcoCoverPages: string;
  hvcoGuideValuesitems: hvcoGuideValuesItemsProps;
};
          ...
          <div className="hvco__left">
            ...
            >
              ...
              <motion.em
                ...
                style={{
                  fontStyle: "normal",
                  color: hvcoheader.highlightColor,
                  whiteSpace: "nowrap",
                }}
              >
                {hvcoheader.highlight}
              </motion.em>{" "}
              <br />
              {hvcoheader.mainSubTwo}
            </motion.h2>
                  ...
                  {hvcoFormInput.map((item, index) => {
                    return (
                      <motion.input
                        ...
                        // Fall back to "" so inputs whose name isn't in the
                        // initial formData (e.g. a project's extra "vehicles"
                        // field) stay controlled from first render.
          ...
          <div className="hvco__right">
            ...
            >
              ...
              <div
                ...
                style={{ borderLeft: `6px solid ${sectionColor}` }}
              >
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={
                ...
                >
                  ...
                  <br />
                  Guide */}
                  {hvcoGuidHeadLine.main}
                  <span style={{ color: sectionColor }}>
                    {hvcoGuidHeadLine.highlight}
                  </span>
                  {hvcoGuidHeadLine.second}
                </motion.div>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={isInView ? { opacity: 1 } : { opacity: 0 }}
            ...
            <div className="guide-value">
              {hvcoGuideValuesitems.map((item, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      fontFamily: "var(--font-bebas)",
                      color: item.isFree ? sectionColor : "var(--white)",
                    }}
