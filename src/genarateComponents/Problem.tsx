...
type ProblemPainCardItem = {
  icon: string;
  title: string;
  description: string;
};

type ProblemPainCardProps = ProblemPainCardItem[];
type ProblemProps = {
  slug: string;
  sectionColor: string;
  ...
  problemheader: HeadeLine;
  problemPhara: string;
  problemQuote: string;
  problemCite: string;
  problemPainCard: ProblemPainCardProps;
  problemBridgeTxt: string;
  problemBridgeTxtStrongColor: string;
  problemBridgeTxtStrong: string;
};
...
export default function Problem({
  ...
  problemPainCard,
  problemBridgeTxt,
  problemBridgeTxtStrong,
}: ProblemProps) {
  const painPoints = problemPainCard;
  ...
  return (
    <>
      <style>{`
        ...
        /* 6-col grid so cards 4 & 5 centre naturally */
        .pain-grid {
          display: grid;
        ...
        @media (max-width: 480px) {
          .problem-section { padding: 2.5rem 1rem; }
          .quote-card {
            padding: 1.25rem;
            margin-bottom: 2.5rem;
          }
      ...
      >
        ...
        <div className="problem-container">
          ...
          <div className="top-row">
            ...
            >
              <h2 className="section-title">
                {problemheader.main}{" "}
                <span className="highlight" style={{ color: sectionColor }}>
                  {problemheader.highlight}
                </span>
                {problemheader.seccondaryText}
              </h2>
              <p className="section-subtitle">{problemPhara}</p>
            </motion.div>
          </div>
          ...
          <div className="pain-grid">
            {painPoints.map((point, index) => (
              ...
              >
                <div
                  className="pain-icon"
                  style={{ background: borderColor || `${sectionColor}12` }}
                >
                  <Image
                    src={point.icon}
                    alt=""
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="quote-icon" style={{ color: sectionColor }}>
              &ldquo;
            </div>
            <p>{problemQuote}</p>
            <cite style={{ color: sectionColor }}>{problemCite}</cite>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="cta-label">There&rsquo;s a better way</p>
            <p className="cta-statement">
              ...
              <em
                style={{
                  fontStyle: "normal",
                  color:
                    slug === "performance-tyres" ? "#0A0A0A" : sectionColor,
                }}
              >
                {problemBridgeTxtStrong}
              </em>
